        ...
        <div className="max-w-2xl">
          ...
          >
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/20 backdrop-blur-sm border border-primary/30">
              ...
              <span className="text-sm font-medium text-orange-100">100% Vegetarian Fire Pizza</span>
            </div>
          </motion.div>
          ...
          >
            Crafted by
            <br />
            <span className="text-orange-400">Fire</span>, Loved
            <br />
            by All.
          </motion.h1>
          ...
          >
            Hand-tossed dough, premium ingredients, and the perfect char from our wood-fired oven. Every pizza tells a story.
          </motion.p>
